...
<%
    ...
    String jdbcURL = "jdbc:mysql://localhost:3306/pajama";
    String jdbcUsername = "root";
    String jdbcPassword = "4708";
...
<body>
    ...
    <div class="sidebar">
         <div class="profile">
            <img style="border-radius: 50%;" src="<%=request.getContextPath()%>/login.png" width="170" height="170" alt="눈송이"/>
            <h2><%= nn %></h2>
            <p><%= sn %></p> 
                ...
                <table class="table">
                    ...
                    <script>
                            ...
                            for (i = 1; i > 0; i--) {
                                ...
                                document.write("<td class='posttitle'>2024년 6월 공지사항입니다.</td>"); 
                                document.write("<td>작성자</td>"); 
                                document.write("<td>24.06.01"+ "</td>");
                                document.write("</tr>");
                        }
                     </script>
                </table>
                ...
                <table class="table">
                    ...
                    if (mealPosts != null) { %>
                        <% for (Post post : mealPosts) { %>
                            <tr class="body">
                                <td class="posttitle"><a href="postView?id=<%= post.getId() %> " style="color:black"><%= post.getTitle() %></a></td>
                    ...
                    <% }}
                    else {%> <td class="posttitle">로그인이 필요합니다.</td>
